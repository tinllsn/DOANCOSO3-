...
import com.example.doan.adapter.AllOrdersAdapter
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.allOrders.collectLatest {
                when (it) {
                    ...
                    is Resource.Success -> {
//                        Ẩn thanh tiến trình, cập nhật ordersAdapter với dữ liệu mới,
  //                        và hiển thị thông báo nếu danh sách đơn hàng trống.
